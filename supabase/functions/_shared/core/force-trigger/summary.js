...
// Vendored from packages/core/dist/force-trigger/summary.js by scripts/vendor-core-into-functions.mjs.
...
export function summarizeForceTrigger(res) {
    if (typeof res !== 'object' || res === null) {
        return { kind: 'failed', floaterCount: 0, alliedCount: 0 };
    }
    // Success shape: count floaters vs. Allied notifications.
    if (res.ok === true) {
        const floaterCount = arrayLength(res.floatAssignmentIds);
        const alliedCount = arrayLength(res.alliedNotifications);
