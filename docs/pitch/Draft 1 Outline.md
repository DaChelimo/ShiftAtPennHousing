...
```
It's 8:05 pm , and floater (advance schedule) is five minutes from arriving.
Hill worker thinks no one is coming and call Harnwell for a floater
Harnwell floater and actual floater all go to Hill
Desk is double covered, because the Hill SW could not know who to call.
```
...
### Slide 14.b - Introducing Shift@Penn

[A screenshot of the web app calendar page and the IOS home page]

**Speaker notes:** In the next few slides, I will walk you through the features in Shift and how it solves each of the problems I mentioned earlier
