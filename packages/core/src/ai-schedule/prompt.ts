...
export function buildSystemPrompt(input: AiScheduleInput, perspective: AiPerspective): string {
  ...
  lines.push(
    '',
    'CONTINUITY RULE (as important as the hard rules): every shift must be at',
    'least 2 hours (4 consecutive slots). Never give anyone a shift shorter than',
    ...
    'D. Keep shifts contiguous and 2 to 5 hours long.',
