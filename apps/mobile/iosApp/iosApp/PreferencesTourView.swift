...
// The tour's CHROME (the header "?" that replays it, and the one-time pointer callout
// anchored to that "?") lives in PreferencesTourChrome.swift. This file is the overlay's
// rendering only. The two were byte-identical duplicates until 2026-07-28; the copy here
// was the stale one left behind by the split.
