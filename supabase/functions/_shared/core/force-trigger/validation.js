...
// Vendored from packages/core/dist/force-trigger/validation.js by scripts/vendor-core-into-functions.mjs.
...
const ADMIN_ROLES = new Set(['sm', 'hm', 'rsm', 'bm']);
export function validateForceTrigger(input) {
    ...
    //    (pinned #1: OR, not AND).
    const isAuthorized = initiator.isScheduleAdmin === true ||
