...
export const sections: NavSection[] = [
  {
    ...
    entries: [
      ...
      { slug: 'workers/dropping-permanently', label: 'Dropping every week' },
  ...
  },
  {
    ...
    entries: [
      ...
      { slug: 'managers/publishing', label: 'Publishing a schedule' },
      { slug: 'managers/editing-published', label: 'Editing a published week' },
